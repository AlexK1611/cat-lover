...
export const selectBreeds = createSelector(selectCats, items => items.breeds)
export const selectSelectedBreed = createSelector(selectCats, items => items.selectedBreed)